...
echo "$blue DNF ile Yüklenecek $white"
  sudo dnf install -y noto-sans-fonts gsettings-desktop-schemas xorg-x11-libs xorg-x11-server humanity-icon-theme patterns-fonts-fonts patterns-fonts-fonts_opt
fi
fi
###################################################################
